...
'@
    ...
    'test_recovered_source_completion_reports_actual_runtime' {
        ...
        $t=[pscustomobject]@{TransactionId='mine';OwnerIdentity='1|99';SourceRuntime='rust';TargetRuntime='rust';Phase='target_healthy';TargetIdentity='77|99';CompletionRuntime='rust'}
        ...
        if($output -cne 'interrupted_cutover_finalized runtime=rust'){throw 'wrong completed runtime displayed'}
