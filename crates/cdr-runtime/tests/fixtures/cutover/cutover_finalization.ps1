...
switch ($CaseName) {
    'test_finalization_refuses_stop_published_after_observation' {
        ...
        $t=[pscustomobject]@{TransactionId='mine';OwnerIdentity='1|99';SourceRuntime='rust';TargetRuntime='rust';Phase='target_started';TargetIdentity='77|99'}
...
'@
    ...
    'test_completion_and_interrupted_completion_use_persisted_identity' {
        ...
        $t=[pscustomobject]@{TransactionId='mine';OwnerIdentity='1|99';SourceRuntime='rust';TargetRuntime='rust';Phase='target_started';TargetIdentity='77|99';CompletionRuntime='rust'}
